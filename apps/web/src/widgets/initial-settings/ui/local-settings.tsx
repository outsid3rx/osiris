...
import { AnimatedStepWidgetWrapper, CardWidgetHeader } from '~shared/ui'
...
export const LocalSettings = reatomComponent<IProps>(({ ctx, onSubmit }) => {
  ...
  return (
    <AnimatedStepWidgetWrapper>
      <Card className="w-sm">
        <CardWidgetHeader
          title="Давайте настроим окружение"
          description="Укажите предпочтительный язык и цветовую схему"
        />
        <CardContent>
          <Form {...form}>
            <form
